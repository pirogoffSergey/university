...
@synthesize a0ParamLabel;
@synthesize a1ParamLabel;
@synthesize a2ParamLabel;
@synthesize a3ParamLabel;
@synthesize a4ParamLabel;
@synthesize resultsTableView;
@synthesize leftBorderLabel;
@synthesize rightBorderLabel;
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
 ...
 /*   if((textField.tag != LEFT_BORDER_FIELD) && (textField.tag != RIGHT_BORDER_FIELD)) {
